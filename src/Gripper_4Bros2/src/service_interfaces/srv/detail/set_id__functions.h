...
#ifndef SERVICE_INTERFACES__SRV__DETAIL__SET_ID__FUNCTIONS_H_
#define SERVICE_INTERFACES__SRV__DETAIL__SET_ID__FUNCTIONS_H_
 ...
 * calls
 * service_interfaces__srv__SetID_Request__init().
...
/**
 * It calls
 * service_interfaces__srv__SetID_Request__fini()
 ...
 * service_interfaces__srv__SetID_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * service_interfaces__srv__SetID_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service_interfaces__srv__SetID_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interfaces
...
/**
 * It calls
 * service_interfaces__srv__SetID_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interfaces
...
/**
 * It allocates the memory for the array and calls
 * service_interfaces__srv__SetID_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interfaces
...
/**
 * It calls
 * service_interfaces__srv__SetID_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVICE_INTERFACES__SRV__DETAIL__SET_ID__FUNCTIONS_H_
