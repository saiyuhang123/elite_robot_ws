...
void EliteDriver::setTrajectoryFeedbackCallback(std::function<void(const TrajectoryMotionFeedback&)> cb) {
    impl_->trajectory_server_->setMotionFeedbackCallback(cb);
}
